...
Vue.directive('dialogDrag', {
  ...
  bind(el, binding, vnode, oldVnode) {
    ...
    dragDom.onmousemove = function (e) {
      ...
      } else if (el.scrollTop + e.clientY > dragDom.offsetTop + dragDom.clientHeight - 10 || dragDom.offsetTop + 10 > e.clientY) {
      ...
      dragDom.onmousedown = (e) => {
        ...
        if (clientX > EloffsetLeft && clientX < EloffsetLeft + elW && clientY > EloffsetTop && clientY < EloffsetTop + 100) {
          ...
          document.onmousemove = function (e) {
            $(".el-dialog__wrapper").css("pointer-events","auto");
            ...
            if(clientY > EloffsetTop && clientY < EloffsetTop + 10){
              ...
              if(clientY > e.clientY){
                dragDom.style.top = e.clientY + 'px';
              ...
              if(clientY < e.clientY){
                if(dragDom.style.height < minHeight){
        ...
        document.onmouseup = function (e) {
          $(".el-dialog__wrapper").css("pointer-events","none");
          document.onmousemove = null;
